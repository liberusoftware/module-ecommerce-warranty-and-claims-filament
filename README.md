...
> This optional Filament 5 presentation package presents exactly one independent domain module. It contributes reusable resources, pages, widgets, schemas, tables, infolists, and actions to application-owned panels while delegating authorization, validation, tenancy, persistence, and business rules to the ecommerce-warranty-and-claims public bounda
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-ecommerce-warranty-and-claims-filament?sort=semver)](https://github.com/liberusoftware/module-ecommerce-warranty-and-claims-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-ecommerce-warranty-and-claims-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-ecommerce-warranty-and-claims-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-ecommerce-warranty-and-claims-filament
```
...
<a href="https://github.com/liberusoftware/module-ecommerce-warranty-and-claims-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-ecommerce-warranty-and-claims-filament" alt="Contributors to liberusoftware/module-ecommerce-warranty-and-claims-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-ecommerce-warranty-and-claims-filament/graphs/contributors).
